...
function decodeJPEG(jpegData, opts) {
  var defaultOpts = { useTArray: false, colorTransform: true };
  if (opts) {
    if (typeof opts === 'object') {
      opts = {
        useTArray:
          typeof opts.useTArray === 'undefined'
            ? defaultOpts.useTArray
            : opts.useTArray,
        colorTransform:
          typeof opts.colorTransform === 'undefined'
            ? defaultOpts.colorTransform
            : opts.colorTransform,
      };
    } else {
      opts = defaultOpts;
